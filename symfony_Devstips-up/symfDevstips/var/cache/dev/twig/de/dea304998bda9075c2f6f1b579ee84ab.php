...
class __TwigTemplate_baf42ec7e6f9cf5f11657f7d4a1053e7 extends Template
{
    private $source;
    private $macros = [];
...
{% macro render_bus_messages(messages, showBus = false) %}
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/messenger.html.twig", "/Users/ulysseperret/Desktop/Projet Annonce/symfony_Devstips/symfDevstips/vendor/symfony/web-profiler-bundle/Resources/views/Collector/messenger.html.twig");
    }
}
